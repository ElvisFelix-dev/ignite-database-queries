...
<p align="center">
  <img alt="GitHub top language" src="https://img.shields.io/github/languages/top/ElvisFelix-dev/ignite-database-queries?style=flat">
...
```
> git clone https://github.com/ElvisFelix-dev/ignite-database-queries.git
```
